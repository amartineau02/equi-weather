...
function displayData(forecast){
	...
	$('.day01 p').html(forecast.daily.data[0].temperatureHigh);
	$('.day02 p').html(forecast.daily.data[1].temperatureHigh);
	$('.day03 p').html(forecast.daily.data[2].temperatureHigh);
	$('.day04 p').html(forecast.daily.data[3].temperatureHigh);
